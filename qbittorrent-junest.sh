...
SHARESAVED="certificates icons" # Enter here keywords or file/folder names to save in both /usr/share and /usr/lib
LIBSAVED="pk p11 alsa jack pipewire pulse cmake python qt" # Enter here keywords or file/folder names to save in /usr/lib
...
mv ./*AppImage ./qBittorrent_"$VERSION"-archimage3.4.1-x86_64.AppImage
