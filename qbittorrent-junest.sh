...
LIBSAVED="pk p11 alsa jack pipewire pulse cmake python qt $lib_browser_launcher" # Enter here keywords or file/directory names to save in /usr/lib
...
mv ./*AppImage ./qBittorrent_"$VERSION"-archimage3.4.4-2-x86_64.AppImage
